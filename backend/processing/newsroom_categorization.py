#!/usr/bin/env python3
"""
Script to categorize newsroom articles using DeepSeek API.
...
def process_articles(input_file: str, output_file: str, scrape_date: str = "6/18/2025"):
    ...
    # Filter out rows without title or link
    valid_rows = []
    for row in rows:
...
def main():
    ...
    # File paths
    input_file = "data/newsroom_reports.csv"
    output_file = "data/newsroom_reports_categorization.csv"
